                ...
                <div className="max-w-6xl mx-auto space-y-10">
                    ...
                    <Tabs defaultValue="register" className="w-full">
                        ...
                        <TabsContent value="download">
                            <Card className="glass border-2"><CardHeader><div className="flex items-center gap-3"><div className="w-12 h-12 rounded-lg bg-green-500/20 flex items-center justify-center"><Download className="w-6 h-6 text-green-400" /></div><div><CardTitle className="text-xl">Download Package</CardTitle><CardDescription>Script automation terbaru</CardDescription></div></div></CardHeader><CardContent><Button className="w-full h-10 text-sm bg-gradient-to-r from-green-600 to-emerald-600"><Download className="w-4 h-4 mr-2" />Download</Button></CardContent></Card>
                        </TabsContent>
                    </Tabs>
